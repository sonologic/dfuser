...
${OBJECTDIR}/Attributes.o: Attributes.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 `pkg-config --cflags fuse`    -MMD -MP -MF $@.d -o ${OBJECTDIR}/Attributes.o Attributes.cpp
...
${OBJECTDIR}/Journal.o: Journal.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 `pkg-config --cflags fuse`    -MMD -MP -MF $@.d -o ${OBJECTDIR}/Journal.o Journal.cpp

${OBJECTDIR}/Repository.o: Repository.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 `pkg-config --cflags fuse`    -MMD -MP -MF $@.d -o ${OBJECTDIR}/Repository.o Repository.cpp
